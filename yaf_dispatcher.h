...
#define YAF_DISPATCHER_PROPERTY_NAME_REQUEST    YAF_STR(YAF_STR__REQUEST)
#define YAF_DISPATCHER_PROPERTY_NAME_VIEW       YAF_STR(YAF_STR__VIEW)
#define YAF_DISPATCHER_PROPERTY_NAME_ROUTER     YAF_STR(YAF_STR__ROUTER)
#define YAF_DISPATCHER_PROPERTY_NAME_INSTANCE   YAF_STR(YAF_STR__INSTANCE)
#define YAF_DISPATCHER_PROPERTY_NAME_RENDER     YAF_STR(YAF_STR__AUTO_RENDER)
#define YAF_DISPATCHER_PROPERTY_NAME_RETURN     YAF_STR(YAF_STR__RETURN_RESPONSE)
#define YAF_DISPATCHER_PROPERTY_NAME_FLUSH      YAF_STR(YAF_STR__INSTANTLY_FLUSH)
#define YAF_DISPATCHER_PROPERTY_NAME_PLUGINS    YAF_STR(YAF_STR__PLUGINS)

#define YAF_DISPATCHER_PROPERTY_NAME_MODULE     YAF_STR(YAF_STR__DMODULE)
#define YAF_DISPATCHER_PROPERTY_NAME_CONTROLLER YAF_STR(YAF_STR__DCONTROLLER)
#define YAF_DISPATCHER_PROPERTY_NAME_ACTION     YAF_STR(YAF_STR__DACTION)
