...
#define YAF_RESPONSE_PROPERTY_NAME_HEADER           YAF_STR(YAF_STR__HEADER)
#define YAF_RESPONSE_PROPERTY_NAME_BODY             YAF_STR(YAF_STR__BODY)
#define YAF_RESPONSE_PROPERTY_NAME_HEADEREXCEPTION  YAF_STR(YAF_STR__SENDHEADER)
#define YAF_RESPONSE_PROPERTY_NAME_DEFAULTBODY      YAF_STR(YAF_STR_CONTENT)
#define YAF_RESPONSE_PROPERTY_NAME_DEFAULTBODYNAME  YAF_STR(YAF_STR_DEFAULT_BODY)
